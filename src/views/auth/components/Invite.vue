<template>
    <el-form
        ...
        class="!text-xs"
    >
        <p class="text-xs font-inter text-[#444444] text-start mb-4">Enter your collaborators emails</p>
        <el-form-item
        ...
        <button type="button" @click="addUser" class="font-semibold text-xs font-inter flex items-center gap-2 text-[#0071FF]">
