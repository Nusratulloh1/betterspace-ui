<template>
    <div class="px-0.5">
        ...
        <el-table :data="tableData" @row-click="goDetail" style="width: 100%">
            ...
            <el-table-column prop="address" label="Resp. teams" min-width="90">
            ...
            <el-table-column prop="address" label="Goal progression" min-width="100">
                <template #default="{}">
                    <div>
            ...
            <el-table-column prop="sprint" label="Milestones" min-width="90">
            ...
            <el-table-column prop="issue" label="Projects health" min-width="90">
...
const goDetail = () => {
    router.push('/workspace/goals/32332')
}
</script>