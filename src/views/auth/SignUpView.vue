    ...
    <div class="min-h-screen">
        <div class="h-[95vh] flex items-center justify-center">
            <div class="text-center w-full max-w-[340px]">
                ...
                <h5 class="font-inter font-medium text-[19px] mt-14 mb-3">Create your Opus account</h5>
                <p class="text-[#676C76] font-inter text-xs">Start to collaborate in context with your teammates now.</p>
                <el-form
                ...
                <div class="flex items-center gap-5 my-5">
                    <hr class="!w-full" />
                    <span class="text-[#A9AEB8] font-inter text-xs uppercase"> or </span>
                    <hr class="!w-full" />
                </div>
                <googleButton />
                <div class="newTo mt-6">
                    <p class="text-[#AAAAAA] text-xs font-inter !leading-[14.5px]">Already using Opus?</p>
                    <router-link to="/signin" class="text-xs font-inter text-primary !leading-[14.5px] hover:underline">
